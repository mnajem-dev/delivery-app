...
// ──────────────────────────────────────────────────────────────────────────
// Catalog: vendors + menu items (US-201/202/203/701/703)
// ──────────────────────────────────────────────────────────────────────────
...
export interface CartItemDto {
  ...
  menuItem?: Pick<
    MenuItemDto,
    'name' | 'imageUrl' | 'priceMinor' | 'priceCurrency'
  >;
}
...
// ──────────────────────────────────────────────────────────────────────────
// Orders (US-302/304/501/503) — create implemented
// ──────────────────────────────────────────────────────────────────────────
...
// ──────────────────────────────────────────────────────────────────────────
// Driver + dispatch (US-601/602/604/605) — contract for not-yet-built endpoints
// ──────────────────────────────────────────────────────────────────────────
...
export interface RideOfferDto {
  ...
  dropoff: { fullAddress: string; lat: number; lng: number };
  distanceKm: number;
  payoutMinor: number;
  currency: string;
  expiresAt: string;
...
// ──────────────────────────────────────────────────────────────────────────
// Ratings (US-901), Admin (US-801/805), Notifications (US-1001)
// ──────────────────────────────────────────────────────────────────────────
